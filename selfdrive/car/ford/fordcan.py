...
def create_acc_msg(packer, CAN: CanBus, long_active: bool, gas: float, accel: float, stopping: bool, v_ego_kph: float):
  ...
  precharge = gas < CarControllerParams.MIN_GAS and long_active
  actuateBrakes = gas < -0.8 and long_active
  values = {
    ...
    "AccBrkPrchg_B_Rq": 1 if precharge else 0,            # Pre-charge brake request: 0=No, 1=Yes
